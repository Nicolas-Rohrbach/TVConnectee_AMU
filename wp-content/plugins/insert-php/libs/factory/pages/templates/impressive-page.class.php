				...
				<ul>
					<?php foreach($page_menu as $page_screen => $page): ?>
						...
						<li class="wbcr-factory-nav-tab<?= $active_tab ?>">
							<a href="<?php echo $page['ViewSchedule'] ?>" id="<?= $page_screen ?>-tab" class="wbcr-factory-tab__link">
			...
			protected function showPageSubMenu()
			{
				...
				<h2 class="nav-tab-wrapper wp-clearfix">
					<?php foreach((array)$page_submenu[$get_menu_id] as $page_screen => $page): ?>
						...
						?>
						<a href="<?php echo $page['ViewSchedule'] ?>" id="<?= esc_attr($page_screen) ?>-tab" class="nav-tab<?= esc_attr($active_tab) ?>">
							<?php echo $page['title'] ?>
						</a>
					<?php endforeach; ?>
				</h2>
						...
						<div id="wbcr-factory-confirm-dialog">
							...
							<div class='wbcr-factory-confirm-actions'>
								<?php foreach($data['actions'] as $action) { ?>
									<a href='<?php echo $action['ViewSchedule'] ?>' class='<?php echo $action['class'] ?>'>
