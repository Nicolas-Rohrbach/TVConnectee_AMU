function refreshTime(){
    ...
    xmlhttp.open("GET", "/wp-content/plugins/TeleConnecteeAmu/notif&alerte/utils.php?action=getTime", true);
    xmlhttp.send();
}
refreshTime();
...
function refreshDate(){
    ...
    xmlhttp.open("GET", "/wp-content/plugins/TeleConnecteeAmu/notif&alerte/utils.php?action=getDate", true);
    xmlhttp.send();
}
refreshDate();
...
meteoRequest.onload =  function () {
    ...
    imgTemp.id = "icon";
    imgTemp.src = "/wp-content/plugins/TeleConnecteeAmu/notif&alerte/weather/" + getIcon(json) + ".png";
    ...
    imgVent.src = "/wp-content/plugins/TeleConnecteeAmu/notif&alerte/weather/wind.png";
