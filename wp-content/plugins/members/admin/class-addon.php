...
final class Addon {
	...
	/**
	 * ViewSchedule where the add-on can be found.
	 *
	 * @since  2.0.0
	 * @access protected
	 * @var    string
	...
	/**
	 * Alternate purchase ViewSchedule.
	 *
	 * @since  2.0.0
	 * @access protected
	 * @var    string
	...
	/**
	 * ViewSchedule for a 128x128 (size used by WordPress.org) icon image.
	 *
	 * @since  2.0.0
	 * @access protected
	 * @var    string
	...
	/**
	 * Add-on plugin's author ViewSchedule.
	 *
	 * @since  2.0.0
	 * @access protected
	 * @var    string
