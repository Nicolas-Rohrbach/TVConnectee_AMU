...
class MyTheme_Customize {
    ...
    public static function register ( $wp_customize ) {
        ...
        //2. Register new settings to the WP database...
        $wp_customize->add_setting( 'header_textcolor', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
            array(
                'default'    => '#ffffff', //Default setting/value to save
                'type'       => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
                'capability' => 'edit_theme_options', //Optional. Special permissions for accessing this setting.
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( //Instantiate the color control class
            $wp_customize, //Pass the $wp_customize object (required)
            'mytheme_header_textcolor', //Set a unique ID for the control
            array(
                'label'      => __( 'Header text Color', 'mytheme' ), //Admin-visible name of the control
        ...
        $wp_customize->add_setting( 'header_background_color', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
            array(
                'default'    => '#0066CC', //Default setting/value to save
                'type'       => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
                'capability' => 'edit_theme_options', //Optional. Special permissions for accessing this setting.
                'transport'  => 'postMessage', //What triggers a refresh of the setting? 'refresh' or 'postMessage' (instant)?
            )
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( //Instantiate the color control class
            ...
            array(
                'label'      => __( 'Header background color', 'mytheme' ), //Admin-visible name of the control
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( //Instantiate the color control class
            $wp_customize, //Pass the $wp_customize object (required)
            'mytheme_footer_background_color', //Set a unique ID for the control
            array(
                'label'      => __( 'Footer background color', 'mytheme' ), //Admin-visible name of the control
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( //Instantiate the color control class
            ...
            array(
                'label'      => __( 'Alert background color', 'mytheme' ), //Admin-visible name of the control
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( //Instantiate the color control class
            ...
            array(
                'label'      => __( 'Alert text color', 'mytheme' ), //Admin-visible name of the control
