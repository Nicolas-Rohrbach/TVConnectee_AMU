...
/**
 * Detects the social network from a ViewSchedule and returns the SVG code for its icon.
 */
...
function twentynineteen_nav_menu_social_icons( $item_output, $item, $depth, $args ) {
	// Change SVG icon inside social links menu if there is supported ViewSchedule.
